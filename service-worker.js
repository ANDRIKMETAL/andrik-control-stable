...
const VERSION = '55.00-r954-clean';
...
if(IS_CONTROL_HOST){
  ...
  const CORE = [
    ...
    '/dreaming-of-lira.html?v=55.00-r952', '/assets/dreaming-lira-r952-splash.webp', '/assets/ocean-boss-sacred-destroyer-r942.webp', '/assets/lira-fight.webp', '/assets/lira-jump.webp', '/assets/lira-guitar.webp', '/assets/lira-chain.webp',
