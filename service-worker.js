...
const VERSION = '55.00-r1171-covers-hub';
...
if(IS_CONTROL_HOST){
  ...
  const CORE = [
    ...
    '/singles.html?v=55.00-r1171', '/covers.html?v=55.00-r1171', '/albums.html?v=55.00-r519', '/uk/albums.html?v=55.00-r519', '/sk/albums.html?v=55.00-r519', '/en/albums.html?v=55.00-r519', '/assets/albums-r446.css?v=55.00-r446', '/assets/albums-r446.js?v=55.00-r446', '/assets/albums-fast-library-r477.js?v=55.00-r519', '/assets/albums-trika-release-r519.css?v=55.00-r519', '/assets/singles-r560.css?v=55.00-r1159', '/assets/singles-r619.js?v=55.00-r1171', '/assets/covers-disc-r1169.png?v=55.00-r1171', '/assets/home-covers-hub-r1171.css?v=55.00-r1171',
