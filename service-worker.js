...
if(IS_CONTROL_HOST){
  ...
  const CORE = [
    ...
    '/singles.html?v=55.00-r330', '/albums.html?v=55.00-r515', '/uk/albums.html?v=55.00-r515', '/sk/albums.html?v=55.00-r515', '/en/albums.html?v=55.00-r515', '/assets/albums-r446.css?v=55.00-r446', '/assets/albums-r446.js?v=55.00-r446', '/assets/singles-r316.css?v=330', '/assets/singles-r316.js?v=330',
