...
if(IS_CONTROL_HOST){
  ...
  const CORE = [
    ...
    '/player.html?v=55.00-r116', '/assets/player-v54-27-r116.js?v=55.00-r116',
    '/assets/player-v54-27.css?v=54.27', '/assets/player-v54-53.css?v=54.54',
    '/assets/player-mini-clean-v55-00-r3u.css?v=55.00-r3u', '/assets/player-shell-bridge-r116.js?v=55.00-r116',
