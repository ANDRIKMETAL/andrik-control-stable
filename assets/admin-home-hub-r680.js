/* ANDRIK R680 — home hub globe + direct side swipes; YouTube opens the current YouTube analytics page. */
(()=>{
  'use strict';
  if(window.__ANDRIK_ADMIN_HUB_R680__)return;
  window.__ANDRIK_ADMIN_HUB_R680__=true;
  ...
  if(!page)return;
  const sideUrls={google:'/analytics-admin.html?page=google&source=admin-hub-swipe&v=55.00-r420',youtube:'/youtube-admin.html?source=admin-hub-swipe&v=55.00-r680'};
  const warmSides=()=>{
    if(window.__ANDRIK_HUB_SIDE_WARM_R680__)return;window.__ANDRIK_HUB_SIDE_WARM_R680__=true;
