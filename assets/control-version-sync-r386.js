/* Control ANDRIK R386 — cache-busted display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R386__) return;
  window.__ANDRIK_VERSION_SYNC_R386__ = true;

  const RELEASE = 'R386';
  const RUNTIME = '55.00-r386';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R386';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 386,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R386',
        build: 'R386 REAL NOTIFICATION HISTORY SPOILER SCROLL',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R386';
      window.ANDRIK_CONTROL_BUILD = 'R386 REAL NOTIFICATION HISTORY SPOILER SCROLL';
