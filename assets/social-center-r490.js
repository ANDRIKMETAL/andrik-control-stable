/* ANDRIK R490 — Social Center controller: accurate Instagram metrics + YouTube OAuth recovery. */
(()=>{
  'use strict';
  if(window.__ANDRIK_SOCIAL_CENTER_R490__)return;
  window.__ANDRIK_SOCIAL_CENTER_R490__=true;
  const RELEASE='R490';
