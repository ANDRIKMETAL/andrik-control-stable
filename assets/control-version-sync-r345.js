/* Control ANDRIK R345 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R345__) return;
  window.__ANDRIK_VERSION_SYNC_R345__ = true;

  const RELEASE = 'R345';
  const RUNTIME = '55.00-r345';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R345';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 345,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R345',
        build: 'R345 COUNTRY ZOOM PULSE SMOOTH',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R345';
      window.ANDRIK_CONTROL_BUILD = 'R345 COUNTRY ZOOM PULSE SMOOTH';
