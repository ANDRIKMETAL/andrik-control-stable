(() => {
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R260__)return;
  window.__ANDRIK_VERSION_SYNC_R260__=true;
  const RELEASE='R260';
  const FULL='Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R260';
  const apply=()=>{
    ...
    try{localStorage.setItem('andrik-control-runtime-version','55.00-r260');}catch(_){}
  };
  apply();
