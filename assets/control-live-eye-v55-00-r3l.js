(() => {
  ...
  const init = () => {
    ...
    style.textContent = `
      ...
      /* R225: only the eye hue, halo and header glow react to system state. */
    ...
    const allowedGlowStates = new Set(['auto','green','blue','red']);
    ...
    const readStageGlowState = () => {
      ...
      const completed = Boolean(
        release?.classList.contains('is-done') &&
