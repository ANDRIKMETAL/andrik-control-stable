/* ANDRIK Control R476 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R476__)return;
  window.__ANDRIK_VERSION_SYNC_R476__=true;
  const RELEASE='R476';
  const RUNTIME='55.00-r476';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R476 R475 BASE + COMPACT LYRA PROMO MOBILE';
