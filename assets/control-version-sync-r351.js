/* Control ANDRIK R351 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R351__) return;
  window.__ANDRIK_VERSION_SYNC_R351__ = true;

  const RELEASE = 'R351';
  const RUNTIME = '55.00-r351';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R351';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 347,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R351',
        build: 'R351 MAP SMOOTH + COUNTRY LIST SCROLL',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R351';
      window.ANDRIK_CONTROL_BUILD = 'R351 MAP SMOOTH + COUNTRY LIST SCROLL';
