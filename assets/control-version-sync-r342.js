/* Control ANDRIK R342 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R342__) return;
  window.__ANDRIK_VERSION_SYNC_R342__ = true;

  const RELEASE = 'R342';
  const RUNTIME = '55.00-r342';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R342';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 342,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R342',
        build: 'R342 TWO-STEP COUNTRY TRANSITION',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R342';
      window.ANDRIK_CONTROL_BUILD = 'R342 TWO-STEP COUNTRY TRANSITION';
