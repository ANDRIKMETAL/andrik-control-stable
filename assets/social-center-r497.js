/* ANDRIK R497 — Social Center: stable Site + YouTube + Instagram dashboard.
   Correct YouTube owner OAuth is now established; temporary reconnect UI removed. */
(()=>{
  'use strict';
  if(window.__ANDRIK_SOCIAL_CENTER_R497__)return;
  window.__ANDRIK_SOCIAL_CENTER_R497__=true;
  const RELEASE='R497';
