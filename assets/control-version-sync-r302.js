/* Control ANDRIK R302 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R302__) return;
  window.__ANDRIK_VERSION_SYNC_R302__ = true;

  const RELEASE = 'R302';
  const RUNTIME = '55.00-r302';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R302';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        full: 'v55.00 LIVE WEB AI FINAL R302',
        build: 'R302 GUARD HEALTH YOUTUBE PUSH BRIDGE',
        date: '06.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R302';
      window.ANDRIK_CONTROL_BUILD = 'R302 GUARD HEALTH YOUTUBE PUSH BRIDGE';
