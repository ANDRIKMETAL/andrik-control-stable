/* ANDRIK Control R398 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R398__)return;
  window.__ANDRIK_VERSION_SYNC_R398__=true;
  const RELEASE='R398';
  const RUNTIME='55.00-r398';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R398 EARLY AUTO SUMMARY CHECKPOINT + UPDATE CLOCKS + VERSION LOCK';
