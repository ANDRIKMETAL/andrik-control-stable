...
(() => {
  ...
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R361';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 361,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R361',
        build: 'R361 SOFT WIDE COUNTRY PULSE',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R361';
      window.ANDRIK_CONTROL_BUILD = 'R361 SOFT WIDE COUNTRY PULSE';
