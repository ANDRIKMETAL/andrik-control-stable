/* Control ANDRIK R347 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R347__) return;
  window.__ANDRIK_VERSION_SYNC_R347__ = true;

  const RELEASE = 'R347';
  const RUNTIME = '55.00-r347';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R347';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 347,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R347',
        build: 'R347 DEFAULT ECOSYSTEM MAP',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R347';
      window.ANDRIK_CONTROL_BUILD = 'R347 DEFAULT ECOSYSTEM MAP';
