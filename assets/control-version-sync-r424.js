/* ANDRIK Control R424 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R424__)return;
  window.__ANDRIK_VERSION_SYNC_R424__=true;
  const RELEASE='R424';
  const RUNTIME='55.00-r424';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R424 LANDSCAPE COUNTRY FILL + FULL ADMIN SWIPE LABEL + R423 ONE-TAP NAV + R416 CRON STABLE';
