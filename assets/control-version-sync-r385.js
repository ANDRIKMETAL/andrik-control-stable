/* Control ANDRIK R385 — cache-busted display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R385__) return;
  window.__ANDRIK_VERSION_SYNC_R385__ = true;

  const RELEASE = 'R385';
  const RUNTIME = '55.00-r385';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R385';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 385,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R385',
        build: 'R385 NOTIFICATION HISTORY SPOILER SCROLL',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R385';
      window.ANDRIK_CONTROL_BUILD = 'R385 NOTIFICATION HISTORY SPOILER SCROLL';
