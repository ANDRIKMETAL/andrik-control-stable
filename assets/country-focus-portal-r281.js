/* Control ANDRIK R281 — selected-country action portal. */
(() => {
  'use strict';
  if (window.__ANDRIK_COUNTRY_ACTION_PORTAL_R281__) return;
  window.__ANDRIK_COUNTRY_ACTION_PORTAL_R281__ = true;
  ...
  function remember() {
    ...
    marker = document.createComment('andrik-r281-map-actions-home');
  ...
  function ensureFill() {
    ...
    fill = document.getElementById('r281CountryBottomFill') || document.createElement('div');
    fill.id = 'r281CountryBottomFill';
  ...
  function restore() {
    ...
    actions.classList.remove('r281-country-actions-portal');
    document.body.classList.remove('r281-country-actions-active');
  ...
  function sync() {
    ...
    requestAnimationFrame(() => {
      ...
      actions.classList.add('r281-country-actions-portal');
      document.body.classList.add('r281-country-actions-active');
      placeFill();
    });
  }
