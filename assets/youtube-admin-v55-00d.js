(() => {
  ...
  const CACHE_KEY='andrik-control-youtube-pane-v55-00d';
  const MONITOR_CACHE_KEY='andrik-control-youtube-monitor-v55-00d';
  ...
  async function connectYoutubeStudio(){
    ...
    if(!getKey()){
      ...
      location.href='/service-admin.html?return=youtube&v=55.00d';
      return;
    }
