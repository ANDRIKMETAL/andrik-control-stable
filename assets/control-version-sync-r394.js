/* ANDRIK Control R394 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R394__)return;
  window.__ANDRIK_VERSION_SYNC_R394__=true;
  const RELEASE='R394';
  const RUNTIME='55.00-r394';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R394 CRON SELF-HEAL + AUTO DAILY ANALYTICS + VERSION LOCK';
