/* Control ANDRIK R303 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R303__) return;
  window.__ANDRIK_VERSION_SYNC_R303__ = true;

  const RELEASE = 'R303';
  const RUNTIME = '55.00-r303';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R303';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        short: RELEASE, number: 303, version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R303',
        build: 'R303 PORTRAIT COUNTRY FULL MAP HEIGHT',
        date: '07.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R303';
      window.ANDRIK_CONTROL_BUILD = 'R303 PORTRAIT COUNTRY FULL MAP HEIGHT';
