(()=>{
  'use strict';
  if(window.__ANDRIK_RADIO_COUNTRIES_R662__)return;
  window.__ANDRIK_RADIO_COUNTRIES_R662__=true;
  ...
  window.AndrikRadioCountriesR662={refresh,refreshMs:MAP_REFRESH_MS};
})();
