/* Control ANDRIK R348 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R348__) return;
  window.__ANDRIK_VERSION_SYNC_R348__ = true;

  const RELEASE = 'R348';
  const RUNTIME = '55.00-r348';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R348';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 347,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R348',
        build: 'R348 COMPACT TOTAL BADGE',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R348';
      window.ANDRIK_CONTROL_BUILD = 'R348 COMPACT TOTAL BADGE';
