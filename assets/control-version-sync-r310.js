/* Control ANDRIK R310 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R310__) return;
  window.__ANDRIK_VERSION_SYNC_R310__ = true;

  const RELEASE = 'R310';
  const RUNTIME = '55.00-r310';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R310';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        short: RELEASE, number: 310, version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R310',
        build: 'R310 NO EXIT MODAL · NO YOUTUBE BACK JUMP',
        date: '08.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R310';
      window.ANDRIK_CONTROL_BUILD = 'R310 NO EXIT MODAL · NO YOUTUBE BACK JUMP';
