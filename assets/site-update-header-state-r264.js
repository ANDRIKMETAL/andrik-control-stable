(() => {
  'use strict';
  if (window.__ANDRIK_SITE_UPDATE_HEADER_R264__) return;
  window.__ANDRIK_SITE_UPDATE_HEADER_R264__ = true;
  ...
  function derive() {
    ...
    // Step 6: blue eye and blue halo.
    if (has(protect,'running')) return 'blue';

    // Step 5: yellow eye and yellow halo, including the short wait before step 6 starts.
