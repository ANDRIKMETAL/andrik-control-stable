/* ANDRIK Control R393 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R393__)return;
  window.__ANDRIK_VERSION_SYNC_R393__=true;
  const RELEASE='R393';
  const RUNTIME='55.00-r393';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R393 CRON SELF-HEAL + AUTO DAILY ANALYTICS + VERSION LOCK';
