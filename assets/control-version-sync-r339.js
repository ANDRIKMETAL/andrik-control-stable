/* Control ANDRIK R339 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R339__) return;
  window.__ANDRIK_VERSION_SYNC_R339__ = true;

  const RELEASE = 'R339';
  const RUNTIME = '55.00-r339';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R339';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 339,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R339',
        build: 'R339 COMPACT COUNTRY MAP',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R339';
      window.ANDRIK_CONTROL_BUILD = 'R339 COMPACT COUNTRY MAP';
