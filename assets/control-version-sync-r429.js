/* ANDRIK Control R429 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R429__)return;
  window.__ANDRIK_VERSION_SYNC_R429__=true;
  const RELEASE='R429';
  ...
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R429 DEDICATED MAP ROUTE + DAILY SUMMARY CATCH-UP + R427 CITY PANEL + R416 CRON STABLE';
