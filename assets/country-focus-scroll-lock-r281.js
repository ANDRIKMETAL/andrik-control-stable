/* Control ANDRIK R281 — lock selected-country portrait view at the top. */
(() => {
  'use strict';
  if (window.__ANDRIK_COUNTRY_SCROLL_LOCK_R281__) return;
  window.__ANDRIK_COUNTRY_SCROLL_LOCK_R281__ = true;
  ...
  function lock() {
    ...
    document.documentElement.classList.add('r281-country-focus-locked');
    document.body.classList.add('r281-country-focus-locked');
    active = true;
    resetScroll();
  ...
  function unlock() {
    active = false;
    document.documentElement.classList.remove('r281-country-focus-locked');
    document.body.classList.remove('r281-country-focus-locked');
  }
