/* Control ANDRIK R350 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R350__) return;
  window.__ANDRIK_VERSION_SYNC_R350__ = true;

  const RELEASE = 'R350';
  const RUNTIME = '55.00-r350';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R350';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 347,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R350',
        build: 'R350 AUTO DAILY STATS + 05:00 17:00 SUMMARY',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R350';
      window.ANDRIK_CONTROL_BUILD = 'R350 AUTO DAILY STATS + 05:00 17:00 SUMMARY';
