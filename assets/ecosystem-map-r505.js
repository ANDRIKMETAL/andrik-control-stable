/* ANDRIK R505 — ecosystem map without TikTok geography. TikTok analytics remain in Social Center only. */
(() => {
  'use strict';
  if (window.__ANDRIK_ECOSYSTEM_MAP_R505__) return;
  window.__ANDRIK_ECOSYSTEM_MAP_R505__ = true;
