/* ANDRIK Control R427 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R427__)return;
  window.__ANDRIK_VERSION_SYNC_R427__=true;
  const RELEASE='R427';
  const RUNTIME='55.00-r427';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R427 CITY PANEL FRAME-BOUND + SIMPLE LIST + R424 COUNTRY FILL + R416 CRON STABLE';
