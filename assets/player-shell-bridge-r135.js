...
(()=>{
  ...
  style.textContent=`
    @keyframes andrikR135BluePlayerPulse{
      0%,100%{
        ...
        box-shadow:
          ...
          0 0 0 0 rgba(96,211,255,.28),
          0 0 20px rgba(70,194,255,.52);
        filter:brightness(1);
      }
      50%{
        transform:scale(1.08);
        box-shadow:
          ...
          0 0 0 11px rgba(96,211,255,0),
          0 0 36px rgba(94,220,255,.96),
          0 0 58px rgba(47,150,255,.48);
        filter:brightness(1.28);
      }
    }

    #andrik-standalone-resume-player,
    #andrik-restore-mini-player{
      right:max(20px,env(safe-area-inset-right))!important;
      border-color:rgba(145,231,255,.86)!important;
      background:
        radial-gradient(circle at 38% 30%,rgba(169,242,255,.92),rgba(50,164,235,.80) 32%,rgba(8,42,77,.98) 72%)!important;
    ...
    #andrik-restore-mini-player:active{
