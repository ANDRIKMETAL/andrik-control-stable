/* Control ANDRIK R308 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R308__) return;
  window.__ANDRIK_VERSION_SYNC_R308__ = true;

  const RELEASE = 'R308';
  const RUNTIME = '55.00-r308';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R308';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        full: 'v55.00 LIVE WEB AI FINAL R308',
        build: 'R308 SAFE PWA EXIT',
        date: '07.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R308';
      window.ANDRIK_CONTROL_BUILD = 'R308 SAFE PWA EXIT';
