(() => {
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R259__)return;
  window.__ANDRIK_VERSION_SYNC_R259__=true;
  const RELEASE='R259';
  const FULL='Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R259';
  const apply=()=>{
    ...
    try{localStorage.setItem('andrik-control-runtime-version','55.00-r259');}catch(_){}
  };
  apply();
