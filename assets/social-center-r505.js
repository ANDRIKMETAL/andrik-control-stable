/* ANDRIK R505 — compact Social Center + real-only Instagram metrics.
   Unavailable Instagram metrics are omitted instead of rendering empty dash cards. */
(()=>{
  'use strict';
  if(window.__ANDRIK_SOCIAL_CENTER_R505__)return;
  window.__ANDRIK_SOCIAL_CENTER_R505__=true;
  const RELEASE='R505';
  ...
  const TIKTOK_MODE_KEY='andrik-tiktok-oauth-mode-r505';
