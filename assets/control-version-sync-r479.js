/* ANDRIK Control R479 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R479__)return;
  window.__ANDRIK_VERSION_SYNC_R479__=true;
  const RELEASE='R479';
  const RUNTIME='55.00-r478';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R479 R478 BASE + APPROVED TRIKA COVER + COUNTDOWN UNDER ART + 3-COVER HOME HUB';
