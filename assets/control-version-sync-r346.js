/* Control ANDRIK R346 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R346__) return;
  window.__ANDRIK_VERSION_SYNC_R346__ = true;

  const RELEASE = 'R346';
  const RUNTIME = '55.00-r346';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R346';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 345,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R346',
        build: 'R346 WORLD COUNTRY ZOOM FAST',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R346';
      window.ANDRIK_CONTROL_BUILD = 'R346 WORLD COUNTRY ZOOM FAST';
