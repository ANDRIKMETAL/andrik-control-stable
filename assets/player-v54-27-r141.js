...
const COLLECTIONS = {
  trika: {
    ...
    label: 'ТРИКА · ОФИЦИАЛЬНЫЙ АЛЬБОМ',
    name: 'ТРИКА',
    note: '17 треков · 2026',
    placeholder: '/assets/trika-third-album-cover-r479.webp',
    url: 'https://youtube.com/playlist?list=OLAK5uy_kwBXo5kmbLBvDgSO7Cnd-9BJBezQkV2bo',
    positionLabel: 'ALBUM'
  },
  ocean: {
    type: 'playlist',
...
if ('serviceWorker' in navigator) navigator.serviceWorker.register('/service-worker.js?v=55.00-r487', { updateViaCache: 'none' }).catch(() => {});
window.setTimeout(() => {
