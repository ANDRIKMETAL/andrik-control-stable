(() => {
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R261__)return;
  window.__ANDRIK_VERSION_SYNC_R261__=true;
  const RELEASE='R261';
  const FULL='Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R261';
  const apply=()=>{
    ...
    try{localStorage.setItem('andrik-control-runtime-version','55.00-r261');}catch(_){}
  };
  apply();
