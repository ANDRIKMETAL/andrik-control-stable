/* ANDRIK Control R428 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R428__)return;
  window.__ANDRIK_VERSION_SYNC_R428__=true;
  const RELEASE='R428';
  const RUNTIME='55.00-r428';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R428 REPEAT MAP ENTRY + LANDSCAPE WORLD SCROLL + R427 CITY PANEL + R416 CRON STABLE';
