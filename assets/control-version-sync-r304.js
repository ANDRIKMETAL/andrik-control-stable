/* Control ANDRIK R304 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R304__) return;
  window.__ANDRIK_VERSION_SYNC_R304__ = true;

  const RELEASE = 'R304';
  const RUNTIME = '55.00-r304';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R304';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        full: 'v55.00 LIVE WEB AI FINAL R304',
        build: 'R304 PORTRAIT COUNTRY MAP FRAME MATCH',
        date: '07.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R304';
      window.ANDRIK_CONTROL_BUILD = 'R304 PORTRAIT COUNTRY MAP FRAME MATCH';
