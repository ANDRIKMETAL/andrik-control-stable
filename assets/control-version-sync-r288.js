/* Control ANDRIK R288 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R288__) return;
  window.__ANDRIK_VERSION_SYNC_R288__ = true;

  const RELEASE = 'R288';
  const RUNTIME = '55.00-r288';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R288';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        full: 'v55.00 LIVE WEB AI FINAL R288',
        build: 'R268 SAFE BASE + PUSH SUMMARY + COUNTRY ONE SCREEN',
        date: '05.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R288';
