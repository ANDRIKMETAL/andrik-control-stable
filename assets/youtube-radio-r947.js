...
function renderYoutube(data){
 ...
 // R947: keep the two counters separate. views = post-Aug-2026 playback starts.
 ...
 const visible=visibleCandidates.length?visibleCandidates[0]:null;
