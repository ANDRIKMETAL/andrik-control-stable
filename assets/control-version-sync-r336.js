/* Control ANDRIK R336 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R336__) return;
  window.__ANDRIK_VERSION_SYNC_R336__ = true;

  const RELEASE = 'R336';
  const RUNTIME = '55.00-r336';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R336';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 336,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R336',
        build: 'R336 LIVE ECOSYSTEM MAP',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R336';
      window.ANDRIK_CONTROL_BUILD = 'R336 LIVE ECOSYSTEM MAP';
