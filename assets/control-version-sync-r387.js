/* Control ANDRIK R387 — cache-busted display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R387__) return;
  window.__ANDRIK_VERSION_SYNC_R387__ = true;

  const RELEASE = 'R387';
  const RUNTIME = '55.00-r387';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R387';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 387,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R387',
        build: 'R387 REAL SPOILER IFRAME CACHE FIX',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R387';
      window.ANDRIK_CONTROL_BUILD = 'R387 REAL SPOILER IFRAME CACHE FIX';
