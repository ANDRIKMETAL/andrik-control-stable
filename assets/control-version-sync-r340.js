/* Control ANDRIK R340 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R340__) return;
  window.__ANDRIK_VERSION_SYNC_R340__ = true;

  const RELEASE = 'R340';
  const RUNTIME = '55.00-r340';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R340';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 340,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R340',
        build: 'R340 GENERAL CLEANUP',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R340';
      window.ANDRIK_CONTROL_BUILD = 'R340 GENERAL CLEANUP';
