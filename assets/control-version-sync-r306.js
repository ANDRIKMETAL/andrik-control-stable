/* Control ANDRIK R306 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R306__) return;
  window.__ANDRIK_VERSION_SYNC_R306__ = true;

  const RELEASE = 'R306';
  const RUNTIME = '55.00-r306';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R306';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        short: RELEASE, number: 306, version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R306',
        build: 'R306 ONE-TAP CONTROL EXIT',
        date: '07.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R306';
      window.ANDRIK_CONTROL_BUILD = 'R306 ONE-TAP CONTROL EXIT';
