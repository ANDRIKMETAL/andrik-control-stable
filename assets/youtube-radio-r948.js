...
// R1045: exact owner YouTube Live API first; enriched public Data API fallback; app link stays R663.
if(!root)return;
...
function armNetworkTimers(){
  ...
  youtubeTimer=setInterval(()=>{if(!document.hidden)loadYoutube()},15000);
