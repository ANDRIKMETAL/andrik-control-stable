/* Control ANDRIK R344 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R344__) return;
  window.__ANDRIK_VERSION_SYNC_R344__ = true;

  const RELEASE = 'R344';
  const RUNTIME = '55.00-r344';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R344';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 344,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R344',
        build: 'R344 DIRECT COUNTRY FAST MAP',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R344';
      window.ANDRIK_CONTROL_BUILD = 'R344 DIRECT COUNTRY FAST MAP';
