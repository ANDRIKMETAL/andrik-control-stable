/* Control ANDRIK R291 — stable selected-country actions on the proven R275 map.
...
(() => {
  'use strict';
  if (window.__ANDRIK_COUNTRY_FOCUS_STABLE_R291__) return;
  window.__ANDRIK_COUNTRY_FOCUS_STABLE_R291__ = true;
  ...
  function remember() {
    ...
    if (!homeMarker) {
      ...
      homeMarker = document.createComment('andrik-r291-map-actions-home');
  ...
  function show() {
    ...
    if (!actions.classList.contains('r291-country-actions-portal')) actions.classList.add('r291-country-actions-portal');
    if (!document.body.classList.contains('r291-country-actions-visible')) document.body.classList.add('r291-country-actions-visible');
  }

  function hide() {
    if (!actions) return;
    actions.classList.remove('r291-country-actions-portal');
    document.body.classList.remove('r291-country-actions-visible');
    actions.hidden = true;
