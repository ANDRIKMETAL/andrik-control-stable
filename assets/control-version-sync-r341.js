/* Control ANDRIK R341 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R341__) return;
  window.__ANDRIK_VERSION_SYNC_R341__ = true;

  const RELEASE = 'R341';
  const RUNTIME = '55.00-r341';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R341';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 341,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R341',
        build: 'R341 REAL COUNTRY MAP + BUTTON FIT',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R341';
      window.ANDRIK_CONTROL_BUILD = 'R341 REAL COUNTRY MAP + BUTTON FIT';
