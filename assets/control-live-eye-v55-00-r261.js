(() => {
  'use strict';
  if(window.__ANDRIK_LIVE_EYE_R261__)return;
  window.__ANDRIK_LIVE_EYE_R261__=true;
  const VERSION='55.00-r261';
  ...
  style.id='andrik-live-eye-style-r261';
  style.textContent=`
