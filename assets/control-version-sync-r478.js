/* ANDRIK Control R478 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R478__)return;
  window.__ANDRIK_VERSION_SYNC_R478__=true;
  const RELEASE='R478';
  ...
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R478 R477 BASE + TRIKA ALBUM HUB + R2 I AM VIDEO';
