/* ANDRIK R540 — current display version; unique asset URL prevents stale footer cache. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R540__)return;
  window.__ANDRIK_VERSION_SYNC_R540__=true;
  const RELEASE='R540';
  const apply=()=>{
