/* Control ANDRIK R280 — selected-country action portal. */
(() => {
  'use strict';
  if (window.__ANDRIK_COUNTRY_ACTION_PORTAL_R280__) return;
  window.__ANDRIK_COUNTRY_ACTION_PORTAL_R280__ = true;
  ...
  function remember() {
    ...
    marker = document.createComment('andrik-r280-map-actions-home');
  ...
  function ensureFill() {
    ...
    fill = document.getElementById('r280CountryBottomFill') || document.createElement('div');
    fill.id = 'r280CountryBottomFill';
  ...
  function restore() {
    ...
    actions.classList.remove('r280-country-actions-portal');
    document.body.classList.remove('r280-country-actions-active');
  ...
  function sync() {
    ...
    requestAnimationFrame(() => {
      ...
      actions.classList.add('r280-country-actions-portal');
      document.body.classList.add('r280-country-actions-active');
      placeFill();
    });
  }
