/* ANDRIK Control R425 — authoritative display-version synchronization. */
(()=>{
  'use strict';
  if(window.__ANDRIK_VERSION_SYNC_R425__)return;
  window.__ANDRIK_VERSION_SYNC_R425__=true;
  const RELEASE='R425';
  const RUNTIME='55.00-r425';
  let busy=false;
  const apply=()=>{
    ...
    try{
      ...
      window.ANDRIK_CONTROL_BUILD='R425 LANDSCAPE CITY LIST + R424 COUNTRY FILL + R423 ONE-TAP NAV + R416 CRON STABLE';
