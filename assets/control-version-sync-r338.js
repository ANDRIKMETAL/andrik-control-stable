/* Control ANDRIK R338 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R338__) return;
  window.__ANDRIK_VERSION_SYNC_R338__ = true;

  const RELEASE = 'R338';
  const RUNTIME = '55.00-r338';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R338';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 338,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R338',
        build: 'R338 COUNTRY DRILLDOWN MAP',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R338';
      window.ANDRIK_CONTROL_BUILD = 'R338 COUNTRY DRILLDOWN MAP';
