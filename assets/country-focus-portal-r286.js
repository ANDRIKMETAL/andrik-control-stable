/* Control ANDRIK R286 — selected-country portal without black filler. */
(() => {
  'use strict';
  if (window.__ANDRIK_COUNTRY_PORTAL_R286__) return;
  window.__ANDRIK_COUNTRY_PORTAL_R286__ = true;
  ...
  function removeLegacyOverlay() {
    ['r283CountryBottomFill', 'r284CountryBottomFill', 'r286CountryBottomFill'].forEach(id => {
      document.getElementById(id)?.remove();
    });
    document.body.classList.remove(
      'r283-country-actions-active',
      'r284-country-actions-active',
      'r283-country-scroll-locked',
      'r284-country-scroll-locked'
    );
    document.querySelectorAll('#mapFocusActions.r283-country-actions-portal,#mapFocusActions.r284-country-actions-portal')
      .forEach(node => node.classList.remove('r283-country-actions-portal', 'r284-country-actions-portal'));
  }
  ...
  function remember() {
    ...
    marker = document.createComment('andrik-r286-map-actions-home');
  ...
  function lockSelectedCountry() {
    if (!pane) return;
    document.body.classList.add('r286-country-scroll-locked');
    if (!wasActive) {
      pane.scrollTop = 0;
      pane.scrollLeft = 0;
  ...
  function unlockSelectedCountry() {
    document.body.classList.remove('r286-country-scroll-locked');
  }

  function restore() {
    if (!actions || !originalParent) return;
    actions.classList.remove('r286-country-actions-portal');
    document.body.classList.remove('r286-country-actions-active');
  ...
  function apply() {
    ...
    actions.classList.add('r286-country-actions-portal');
    document.body.classList.add('r286-country-actions-active');
    wasActive = true;
  }
