...
(() => {
  ...
  const RELEASE = 'R322';
  const RUNTIME = '55.00-r322';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R322';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        short: RELEASE, number: 322, version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R322',
        build: 'R322 R315 STABLE BASE · R2 DELETE · PLAYER MP3',
        date: '08.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R322';
      window.ANDRIK_CONTROL_BUILD = 'R322 R315 STABLE BASE · R2 DELETE · PLAYER MP3';
