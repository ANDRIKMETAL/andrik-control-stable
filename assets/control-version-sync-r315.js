...
(() => {
  ...
  const RELEASE = 'R333';
  const RUNTIME = '55.00-r333';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R333';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        short: RELEASE, number: 331, version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R333',
        build: 'R328 R325 STABLE BASE · PLAYER MP3 ENDPOINT FIX',
        date: '08.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R333';
      window.ANDRIK_CONTROL_BUILD = 'R328 R325 STABLE BASE · PLAYER MP3 ENDPOINT FIX';
