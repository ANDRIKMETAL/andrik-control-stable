...
(() => {
  ...
  const RELEASE = 'R331';
  const RUNTIME = '55.00-r331';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R331';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        full: 'v55.00 LIVE WEB AI FINAL R331',
        build: 'R328 R325 STABLE BASE · PLAYER MP3 ENDPOINT FIX',
        date: '08.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R331';
