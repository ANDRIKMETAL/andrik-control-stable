...
(() => {
  ...
  const RELEASE = 'R335';
  const RUNTIME = '55.00-r335';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R335';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        full: 'v55.00 LIVE WEB AI FINAL R335',
        build: 'R328 R325 STABLE BASE · PLAYER MP3 ENDPOINT FIX',
        date: '08.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R335';
