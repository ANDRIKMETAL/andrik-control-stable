/* Control ANDRIK R305 — safe display-version synchronization.
   Never writes text into <html> or <body>. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R305__) return;
  window.__ANDRIK_VERSION_SYNC_R305__ = true;

  const RELEASE = 'R305';
  const RUNTIME = '55.00-r305';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R305';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        short: RELEASE, number: 305, version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R305',
        build: 'R305 AUTO SUMMARY + MAP FRAME FINAL DROP',
        date: '07.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R305';
      window.ANDRIK_CONTROL_BUILD = 'R305 AUTO SUMMARY + MAP FRAME FINAL DROP';
