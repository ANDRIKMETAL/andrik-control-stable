/* ANDRIK R971 — Instagram monthly archive fix on top of R970.
   Keeps the existing R337 localStorage archive key so all previously saved months survive. */
(() => {
  'use strict';
  if (window.__ANDRIK_MAP_MONTHLY_R971__) return;
  window.__ANDRIK_MAP_MONTHLY_R971__ = true;
  ...
  const LAYERS=['all','site','technical','youtube','instagram','music','push'];
