/* Control ANDRIK R510 — stable four-platform daily summary, non-overlapping cards, persistent YouTube today, releases restored. */
(() => {
  ...
  function renderPlatformSummaryR509(data={}){
    ...
    const cards=[
      ...
      platformCardR509({key:'youtube',title:'YouTube',icon:'▶',scope:archive?'точный день':'с 00:00',href:'/youtube-admin.html?refresh=1&v=55.00-r510',metrics:[
      ...
      platformCardR509({key:'instagram',title:'Instagram',icon:'◎',scope:archive?'нет архивного среза':'свежий срез · 28 дней',href:'/social-center-admin.html?source=summary&v=55.00-r510',metrics:archive?[]:[
      ...
      platformCardR509({key:'tiktok',title:'TikTok',icon:'♪',scope:archive?'нет архивного среза':'текущий срез',href:'/social-center-admin.html?source=summary&v=55.00-r510',metrics:archive?[]:[
  ...
  async function hydrateSocialSummaryR509(data={}){
    ...
    socialFetchPromiseR509=api(`/api/control/social-overview?fast=1&tiktok_mode=${encodeURIComponent(mode)}&v=55.00-r510`,{timeoutMs:9000})
