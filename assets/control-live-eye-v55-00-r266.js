(() => {
  'use strict';
  if(window.__ANDRIK_LIVE_EYE_R266__)return;
  window.__ANDRIK_LIVE_EYE_R266__=true;
  const VERSION='55.00-r266';
  ...
  style.textContent=`
    ...
    html[data-andrik-section-lock="blue"] body.control-page .control-topbar .control-center-logo[data-r3d-live-eye="1"] .andrik-live-eye-motion-r244.andrik-live-eye-motion-r3d .logo-ok,
    html[data-andrik-section-lock="blue"] body.comments-admin-page .control-topbar .control-center-logo[data-r3d-live-eye="1"] .andrik-live-eye-motion-r244.andrik-live-eye-motion-r3d .logo-ok{filter:brightness(1.46) saturate(2.55) hue-rotate(78deg) contrast(1.08) drop-shadow(0 0 16px rgba(205,245,255,.99)) drop-shadow(0 0 40px rgba(72,176,255,.98)) drop-shadow(0 0 62px rgba(86,196,255,.92))!important}
    html[data-andrik-section-lock="yellow"] body.control-page .control-topbar .control-center-logo[data-r3d-live-eye="1"] .andrik-live-eye-motion-r244.andrik-live-eye-motion-r3d .logo-ok{filter:brightness(1.50) saturate(2.52) sepia(.48) hue-rotate(-18deg) contrast(1.10) drop-shadow(0 0 16px rgba(255,247,190,.99)) drop-shadow(0 0 40px rgba(255,190,42,.98)) drop-shadow(0 0 62px rgba(255,221,91,.92))!important}
    html[data-andrik-header-state="green"] body.site-update-page .control-topbar .control-center-logo[data-r3d-live-eye="1"] .andrik-live-eye-motion-r244.andrik-live-eye-motion-r3d .logo-ok{filter:brightness(1.28) saturate(1.72) drop-shadow(0 0 14px rgba(168,255,209,.98)) drop-shadow(0 0 36px rgba(31,255,150,.90)) drop-shadow(0 0 56px rgba(86,255,177,.80))!important}
    html[data-andrik-header-state="yellow"] body.site-update-page .control-topbar .control-center-logo[data-r3d-live-eye="1"] .andrik-live-eye-motion-r244.andrik-live-eye-motion-r3d .logo-ok{filter:brightness(1.50) saturate(2.52) sepia(.48) hue-rotate(-18deg) contrast(1.10) drop-shadow(0 0 16px rgba(255,247,190,.99)) drop-shadow(0 0 40px rgba(255,190,42,.98)) drop-shadow(0 0 62px rgba(255,221,91,.92))!important}
    html[data-andrik-header-state="blue"] body.site-update-page .control-topbar .control-center-logo[data-r3d-live-eye="1"] .andrik-live-eye-motion-r244.andrik-live-eye-motion-r3d .logo-ok{filter:brightness(1.46) saturate(2.55) hue-rotate(78deg) contrast(1.08) drop-shadow(0 0 16px rgba(205,245,255,.99)) drop-shadow(0 0 40px rgba(72,176,255,.98)) drop-shadow(0 0 62px rgba(86,196,255,.92))!important}
    html[data-andrik-header-state="red"] body.site-update-page .control-topbar .control-center-logo[data-r3d-live-eye="1"] .andrik-live-eye-motion-r244.andrik-live-eye-motion-r3d .logo-ok{filter:brightness(1.30) saturate(2.45) hue-rotate(238deg) contrast(1.10) drop-shadow(0 0 16px rgba(255,150,160,.99)) drop-shadow(0 0 40px rgba(255,39,68,.98)) drop-shadow(0 0 62px rgba(255,70,91,.92))!important}
  ...
  const adminBluePage=(
    ['service','monitor','releases','discussion'].includes(adminSection)||
