/* ANDRIK R495 — Social Center: Site + YouTube + Instagram; TikTok reserved. YouTube reconnect UI removed. */
(()=>{
  'use strict';
  if(window.__ANDRIK_SOCIAL_CENTER_R495__)return;
  window.__ANDRIK_SOCIAL_CENTER_R495__=true;
  const RELEASE='R495';
