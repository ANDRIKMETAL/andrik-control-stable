/* Control ANDRIK R337 — safe display-version synchronization. */
(() => {
  'use strict';
  if (window.__ANDRIK_VERSION_SYNC_R337__) return;
  window.__ANDRIK_VERSION_SYNC_R337__ = true;

  const RELEASE = 'R337';
  const RUNTIME = '55.00-r337';
  const FULL = 'Live Web AI · ANDRIK · v55.00 LIVE WEB AI FINAL R337';
  let applying = false;
  ...
  const apply = () => {
    ...
    try {
      ...
      window.ANDRIK_CONTROL_RELEASE = Object.freeze({
        ...
        number: 337,
        version: '55.00',
        full: 'v55.00 LIVE WEB AI FINAL R337',
        build: 'R337 PER-LAYER MAP ANALYTICS',
        date: '09.08.2026'
      });
      window.ANDRIK_CONTROL_VERSION = '55.00 LIVE WEB AI FINAL R337';
      window.ANDRIK_CONTROL_BUILD = 'R337 PER-LAYER MAP ANALYTICS';
