const ANDRIK_CONTROL_RELEASE = Object.freeze({ short:'R448', number:448, version:'55.00', full:'55.00 LIVE WEB AI FINAL R448', siteUpdater:'55.00-r356' });
      ...
      if (request.method === 'GET' || request.method === 'HEAD') {
        ...
        if (isControlHost && (path === '/analytics-admin.html' || path === '/analytics-admin')) {
          ...
          if (!allowedSide && !allowedMap) {
            const adminUrl = new URL('/control-home.html?page=menu&source=launch-guard-r448&v=55.00-r448', url);
