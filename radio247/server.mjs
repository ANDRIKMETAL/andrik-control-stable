...
const state = {
  ...
  version: 'R708-AGENT-ESM-MORNING-PULL-R707-PRESERVED',
  mode: 'R708 OVH AGENT ESM FIX + MORNING PULL / R707 EXACT TITLE SYNC / R706 TRUE-MOTION EQ / R702 MP3+CLIP PRESERVED',
  startedAt: new Date().toISOString(),
  streamStartedAt: null,
  publisherRunning: false,
  producerRunning: false,
  overlayMode: 'R708 R707 TITLE SYNC PRESERVED / R706 TRUE-MOTION 4-SLOT EQ / BETWEEN TITLE + TICKER / AUTO FIT NO CROP',
