...
const state = {
  ...
  version: 'R652-R649-STRETCH-R2-PICKER-CLEAN-1080P-CONTINUOUS-AUDIO',
  mode: 'R652 CLEAN + R649-STRETCH + R2 VIDEO PICKER / R648 PUSH+D1+APP / DAY-EVENING-NIGHT / EXACT 1920x1080 NO CROP / CONTINUOUS PCM + ONE AAC CLOCK / NO PACKET DROP / LIVE TICKER + QR',
