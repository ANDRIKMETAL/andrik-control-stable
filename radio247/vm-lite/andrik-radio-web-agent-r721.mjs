...
async function daemon(){
  while(true){
    try{
      ...
      const d=await jsonFetch(BASE+'/api/radio-agent-r627/poll',{method:'POST',headers,body:JSON.stringify({version:'R721',status})});
...
async function main(){
  ...
  console.log('ANDRIK Radio Web Agent R721 · commands: daemon | status | bootstrap-visuals | visual-sync | visual-now <morning|day|evening|night> | visual-auto');
}
