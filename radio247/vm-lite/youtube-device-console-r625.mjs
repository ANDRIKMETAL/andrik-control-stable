...
async function main(){
  ...
  console.log('ANDRIK YouTube Console R625');
  console.log('Команды: pair CODE | auth | status | create | launch | auto | auto-safe | start | recover | end');
}
