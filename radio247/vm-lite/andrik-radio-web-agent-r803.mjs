...
async function localStatus(){
  try{
    ...
    const status={service:run('systemctl',['is-active','andrik-radio.service'],8000).output.trim(),producer:Boolean(d.producerRunning),publisher:Boolean(d.publisherRunning),videoFeederRunning:Boolean(d.videoFeederRunning),clipActive:Boolean(d.clipActive),current:c.title||'',next:n.title||'',audio:d.audioMode||'',version:d.version||'',visualPeriod:d.visualPeriod||'',visualPath:d.visualPath||'',forceVisualSlot:d.forceVisualSlot||'',visualAutoSchedule:Boolean(d.visualAutoSchedule),visualProtected:visualsProtected(),lastError:clean(d.lastError||''),lastFfmpegLine:clean(d.lastFfmpegLine||''),lastExit:d.lastExit||null,diagnosticsR802:d.diagnosticsR802||null,diagnosticsR803:d.diagnosticsR802||null,diagnosticsR813:d.diagnosticsR802||null,diagnosticsR814:d.diagnosticsR802||null,diagnosticsR816:d.diagnosticsR802||null,diagnosticsR817:d.diagnosticsR802||null,diagnosticsR818:d.diagnosticsR802||null,diagnosticsR819:d.diagnosticsR802||null,
      ...
      streamProfileR819:d.streamProfileR819||d.streamProfileR818||d.streamProfileR817||d.streamProfileR816||d.streamProfileR814||d.streamProfileR813||null,streamProfileR818:d.streamProfileR818||d.streamProfileR819||d.streamProfileR817||d.streamProfileR816||d.streamProfileR814||d.streamProfileR813||null,streamProfileR817:d.streamProfileR817||d.streamProfileR818||d.streamProfileR816||d.streamProfileR814||d.streamProfileR813||null,streamProfileR816:d.streamProfileR816||d.streamProfileR817||d.streamProfileR814||d.streamProfileR813||null,streamProfileR814:d.streamProfileR814||d.streamProfileR816||d.streamProfileR813||null,streamProfileR813:d.streamProfileR813||d.streamProfileR816||{
    ...
    const status={service:run('systemctl',['is-active','andrik-radio.service'],8000).output.trim(),producer:false,publisher:false,videoFeederRunning:false,clipActive:false,current:'',next:'',libraryTracks:0,libraryAlbumTracks:0,librarySingleTracks:0,duplicateSinglesSkipped:0,libraryVideos:0,libraryBumpers:0,librarySpecial:0,librarySpecial30:0,librarySpecial60:0,lastLibraryRefresh:'',inventoryTelemetry:'R805-LIVE-LIBRARY-COUNTERS',ticker:currentTicker(),busy:busy?{id:busy.id,action:busy.action,since:busy.since}:null,error:'local-status-unavailable',lastError:clean(error?.message||error),lastFfmpegLine:'',diagnosticsR802:null,diagnosticsR803:null,diagnosticsR813:null,diagnosticsR814:null,diagnosticsR816:null,diagnosticsR817:null,diagnosticsR818:null,diagnosticsR819:null,rtmpsEstablishedConnectionsR792:0,rtmpsExpectedConnectionsR792:2,transportHealthy:false,
      streamProfileR819:{video:{codec:'H.264 / AVC',encoder:'libx264 (persistent master only)',profile:'High 4.1',width:1920,height:1080,fps:25,bitrate:'6000k',gopFrames:50,bFrames:0,pixelFormat:'yuv420p',sampleAspectRatio:'1:1',displayAspectRatio:'16:9'},audio:{codec:'AAC-LC',sampleRate:44100,channels:2,channelLayout:'stereo',bitrate:'160k'},transport:{container:'FLV',protocol:'RTMPS',lanes:0,expectedLanes:2,dualIngest:true},handoff:{mode:'R816-RAWVIDEO-FRAME-ALIGNED',frameAligned:true,feederCodec:'rawvideo',persistentEncoder:true},geometry:{raster:'1920x1080',sampleAspectRatio:'1:1',displayAspectRatio:'16:9',fullFrame:true,noCrop:true}},streamProfileR818:d.streamProfileR818||d.streamProfileR819||null,streamProfileR816:{video:{codec:'H.264 / AVC',encoder:'libx264 (persistent master only)',profile:'High 4.1',width:1920,height:1080,fps:25,bitrate:'6000k',gopFrames:50,bFrames:0,pixelFormat:'yuv420p'},audio:{codec:'AAC-LC',sampleRate:44100,channels:2,channelLayout:'stereo',bitrate:'160k'},transport:{container:'FLV',protocol:'RTMPS',lanes:0,expectedLanes:2,dualIngest:true},handoff:{mode:'R816-RAWVIDEO-FRAME-ALIGNED',frameAligned:true,feederCodec:'rawvideo',persistentEncoder:true}},streamProfileR814:null,streamProfileR813:{video:{codec:'H.264 / AVC',encoder:'libx264',profile:'High 4.1',width:1920,height:1080,fps:25,bitrate:'6000k',gopFrames:50,bFrames:0,pixelFormat:'yuv420p'},audio:{codec:'AAC-LC',sampleRate:44100,channels:2,channelLayout:'stereo',bitrate:'160k'},transport:{container:'FLV',protocol:'RTMPS',lanes:0,expectedLanes:2,dualIngest:true}},
