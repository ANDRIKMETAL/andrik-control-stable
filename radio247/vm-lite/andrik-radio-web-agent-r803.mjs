...
async function localStatus(){
  try{
    ...
    const status={service:run('systemctl',['is-active','andrik-radio.service'],8000).output.trim(),producer:Boolean(d.producerRunning),publisher:Boolean(d.publisherRunning),videoFeederRunning:Boolean(d.videoFeederRunning),clipActive:Boolean(d.clipActive),current:c.title||'',next:n.title||'',audio:d.audioMode||'',version:d.version||'',visualPeriod:d.visualPeriod||'',visualPath:d.visualPath||'',forceVisualSlot:d.forceVisualSlot||'',visualAutoSchedule:Boolean(d.visualAutoSchedule),visualProtected:visualsProtected(),lastError:clean(d.lastError||''),lastFfmpegLine:clean(d.lastFfmpegLine||''),lastExit:d.lastExit||null,diagnosticsR802:d.diagnosticsR802||null,diagnosticsR813:d.diagnosticsR802||null,diagnosticsR814:d.diagnosticsR802||null,diagnosticsR815:d.diagnosticsR802||null,
      ...
      streamProfileR815:d.streamProfileR815||d.streamProfileR814||d.streamProfileR813||null,streamProfileR814:d.streamProfileR814||d.streamProfileR813||null,streamProfileR813:d.streamProfileR813||{
