...
(() => {
  ...
  function renderSummary(data){
    ...
    if(updatedBox)updatedBox.textContent=`Обновлено ${compactTime}`;
    syncCarouselClones();
  }
  ...
  const shell=$('controlSwipeShell');
    ...
    try{
      const data=await api(forceLive?'/api/control/home?refresh=1&v=55.00-final-hotfix':'/api/control/home?v=55.00-final-hotfix',{timeoutMs:forceLive?13000:8000});
