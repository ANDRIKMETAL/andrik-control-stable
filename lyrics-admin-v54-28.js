(() => {
  ...
  function updatePlayButton(){const b=document.getElementById('lyricsPlayPause');if(!b||!playerReady)return;let state=-1;try{state=player.getPlayerState()}catch(_){}b.textContent=state===1?'⏸ Пауза':'▶ Воспроизвести'}
